...
function saveGridLayout(){
	...
	setCookie(this.cookieName,JSON.stringify(res));
}

function updateCustomGrid(items){
	var grid = $('.grid-stack').data('gridstack');
	var res = _.map($('.grid-stack .grid-stack-item:visible'), function (el) {
	    el = $(el);
	    _.each(items, function (node) {
	    	if(node.id == el.attr('data-custom-id')){
...
function updateCustomView(widgets, items){
	widgets.forEach(function(widget) {
		var elem = document.querySelector('#'+widget);
...
function togglePin(id, toggle){
	var grid = $('.grid-stack').data('gridstack');
	var res = _.map($('.grid-stack .grid-stack-item:visible'), function (el) {
	    el = $(el);
    	if(id == el.attr('data-custom-id')){
        	grid.resizable(el, toggle);
        	grid.movable(el, toggle);
    	}
	});
}
...
function addWidget(id){
	...
	var res = _.map($('.grid-stack .grid-stack-item:visible'), function (el) {
	    el = $(el);
    	if(id == el.attr('data-custom-id')){
        	grid.add_widget(el, 0, 0, 6, 5, true);
    	}
	});
	saveGridLayout();
}
...
function loadMainDashboardGrid(){
	this.cookieName = "layout-main-dashboard";
	var widgets = ["itemRoadMap", "itemActivities", "itemAlerts", "itemTeam", "itemCalendar", "itemBoxes"];
	var serialized_data = getCookie(this.cookieName);
	var items = [];
	...
	if(serialized_data == null){
		items = [{"id":"itemRoadMap","x":0,"y":5,"width":12,"height":6},{"id":"itemActivities","x":6,"y":11,"width":6,"height":5},{"id":"itemCalendar","x":0,"y":16,"width":6,"height":5},{"id":"itemTeam","x":0,"y":11,"width":6,"height":5},{"id":"itemAlerts","x":6,"y":0,"width":6,"height":5},{"id":"itemBoxes","x":0,"y":0,"width":6,"height":5}];
	}else{
		items = JSON.parse(serialized_data);
	}
	updateCustomView(widgets, items);
	updateCustomGrid(items);
}

function loadBoxDashboardGrid(){
	this.cookieName = "layout-box-dashboard";
	var widgets = ["itemProjects", "itemTasks", "itemRoadMap", "itemActivities"];
	var serialized_data = getCookie(this.cookieName);
	var items = [];
	if (serialized_data == undefined || serialized_data == null || serialized_data == "")
	{
	...
	if(serialized_data == null){
		items =[{"id":"itemProjects","x":0,"y":0,"width":6,"height":5},{"id":"itemTasks","x":6,"y":0,"width":6,"height":5},{"id":"itemRoadMap","x":0,"y":5,"width":12,"height":5},{"id":"itemActivities","x":0,"y":10,"width":6,"height":5}];
	}else{
		items = JSON.parse(serialized_data);
	}
	updateCustomView(widgets, items);
...
function loadProjectDashboardGrid(){
	this.cookieName = "layout-project-dashboard";
	var widgets = ["itemDetails", "itemStatus", "itemRoadMap", "itemTasks", "itemActivities", "itemNotes", "itemCalendar", "itemTeam", "itemAlerts"];
	var serialized_data = getCookie(this.cookieName);
	var items = [];
	if (serialized_data == undefined || serialized_data == null || serialized_data == "")
	{
	...
	if(serialized_data == null){
		items =[{"id":"itemDetails","x":0,"y":16,"width":6,"height":5},{"id":"itemStatus","x":0,"y":26,"width":12,"height":5},{"id":"itemRoadMap","x":0,"y":0,"width":12,"height":6},{"id":"itemTasks","x":6,"y":11,"width":6,"height":5},{"id":"itemActivities","x":0,"y":11,"width":6,"height":5},{"id":"itemNotes","x":6,"y":16,"width":6,"height":5},{"id":"itemCalendar","x":6,"y":6,"width":6,"height":5},{"id":"itemTeam","x":0,"y":21,"width":6,"height":5},{"id":"itemAlerts","x":0,"y":6,"width":6,"height":5}];
	}else{
		items = JSON.parse(serialized_data);
	}
	updateCustomView(widgets, items);
...
function loadTaskDashboardGrid(){
	this.cookieName = "layout-task-dashboard";
	var widgets = ["itemDetails", "itemNotes", "itemAlerts", "itemActivities"];
	var serialized_data = getCookie(this.cookieName);
	var items = [];
	if (serialized_data == undefined || serialized_data == null || serialized_data == "")
	{
	...
	if(serialized_data == null){
		items =[{"id":"itemDetails","x":0,"y":0,"width":6,"height":5},{"id":"itemNotes","x":6,"y":0,"width":6,"height":5},{"id":"itemAlerts","x":6,"y":5,"width":6,"height":5},{"id":"itemActivities","x":0,"y":5,"width":6,"height":5}];
	}else{
		 items = JSON.parse(serialized_data);
	}
	updateCustomView(widgets, items);
